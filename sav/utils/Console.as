package sav.utils
{
	...
	{		
		...
		public static function triggerPhase(phaseName:String, startParams:Array = null, onCompleteFunc:Function = null):*
		{
		...
		private static function phaseComplete(evt:Event):void
		{
			...
			{
				var onCompleteParams:Array = Object(phase).onCompleteParams;
				onCompleteFunc.apply(null, onCompleteParams);
			}
