...
package sav.components
{
	...
	[Event(name = 'scrolled', type = 'sav.components.Scroller')]
	[Event(name = 'scrollAbleChanged', type = 'sav.components.Scroller')]
	[Event(name = 'scrollComplete', type = 'sav.components.Scroller')]
	...
	public class Scroller extends Sprite 
	{
		...
		public function updateDragArea(updateContentPosition:Boolean = true):void
		{
			...
			//trace('th = ' + th);
			//trace('move able area = ' + _moveAbleArea);
		...
		protected function minBarMouseDown(evt:MouseEvent):void
		{
			_scrolling = true;
		...
		protected function minBarMouseUp(evt:MouseEvent):void
		{		
			_scrolling = false;
		...
		protected function maxBarMouseDown(evt:MouseEvent):void
		{
			_scrolling = true;
		...
		protected function maxBarMouseUp(evt:MouseEvent):void
		{
			_scrolling = false;
