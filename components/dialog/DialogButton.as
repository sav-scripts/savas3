package sav.components.dialog
{
	...
	public class DialogButton extends SimpleButton
	{
		...
		private function getState(state:String = ''):Sprite
		{
			...
			var c5:Number = ColorUtils.blend(color, 0x000000, 0.5);
			...
			//var c1:uint = ColorUtils.blend(color, 0x000000, 0.18);
			//if (state == 'over') color = ColorUtils.blend(color, 0xffffff, 0.4);
			
			var c3:uint = ColorUtils.blend(color, 0xffffff, 0.10);
			var c1:uint = (state == 'over') ? 	ColorUtils.blend(color, 0xffffff, 0.20) :
												ColorUtils.blend(color, 0x000000, 0.08);
			var c2:uint = ColorUtils.blend(color, 0xffffff, 0.20);
			...
			//if (state == 'over') textColor = ColorUtils.blend(textColor, 0x000000, 0.5);
