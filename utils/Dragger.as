package sav.utils
{
	...
	public class Dragger
	{
		...
		public static function add(
			...
			useInt:Boolean = true, 
			movingLimit:Rectangle = null,
			onMouseDown:Function = null,
			onMouseUp:Function = null):void
		{
			...
			var obj:Object = { numDrags:numDrags, target:target, hitArea:hitArea, position:new Point(), onMouseMove:onMouseMove, useInt:useInt, movingLimit:movingLimit, onMouseDown:onMouseDown, onMouseUp:onMouseUp };
		...
		private static function objectMouseDown(evt:MouseEvent):void
		{
			...
			var func:Function = obj.onMouseDown;
		...
		private static function objectMouseUp(evt:MouseEvent):void
		{
			...
			var func:Function = obj.onMouseUp;
			if (func != null) func.apply();
